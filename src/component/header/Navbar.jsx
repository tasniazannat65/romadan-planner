...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div   className={`fixed top-0 left-0 w-full z-50 px-3 md:px-6 transition-all duration-300 ${scrolled ? "bg-base-100 shadow-md" : "bg-transparent"} `}
 ref={menuRef}>
        <div className="nb-pill max-w-7xl mx-auto">

          {/* Logo */}
          <NavLink to="/" className="nb-logo text-[10px] md:text-lg">
